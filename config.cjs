...
const config = {
  ...
  PREFIX: process.env.PREFIX || '.',
   BOT_NAME: process.env.BOT_NAME || "HACKLINK-XD",
   BOT: process.env.BOT || "hello 👋",
  NEW_CMD: process.env.NEW_CMD || "ᴀᴅᴅᴠᴀʀ\n│ sᴜᴅᴏ\n| inconnu",
  CAPTION: process.env.CAPTION|| "ᴘᴏᴡᴇʀᴇᴅ ʙʏ HACKLINK TECH.INC*",
  ...
  DELETED_MESSAGES_CHAT_ID: process.env.DELETED_MESSAGES_CHAT_ID || "254769677305@s.whatsapp.net",
  OWNER_NAME: process.env.OWNER_NAME || "Hacklink dev",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "254769677305",
  SUDO_NUMBER: process.env.SUDO_NUMBER || "254769677305",
